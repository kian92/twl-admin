  ...
  return (
    <header className="h-16 border-b bg-card flex items-center justify-between px-6">
      <div className="ml-10 md:ml-0">
        <h2 className="text-xs md:text-lg font-semibold">{t('header.welcomeBack', { name: displayName })}</h2>
        <p className="text-xs md:text-sm text-muted-foreground capitalize">{t('header.account', { role })}</p>
      </div>
